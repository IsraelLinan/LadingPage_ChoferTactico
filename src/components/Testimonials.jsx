...
const TESTIMONIALS = [
  { name: "Sarah & Tom",      country: "United States", flag: "🇺🇸", rating: 5, tour: "Premium Miraflores Tour",   text: "Cristhofer is absolutely amazing! He picked us up at our hotel, took us to all the iconic spots in Miraflores and Barranco, and gave us so much historical context. The ceviche lunch he recommended was the best meal of our trip. We felt completely safe and taken care of. 100% recommend!", avatar: "ST", color: "bg-blue-500" },
  { name: "Laura Hoffmann",   country: "Germany",       flag: "🇩🇪", rating: 5, tour: "Sunset + Barranco Tour",   text: "Der Sonnenuntergang vom Malecón war atemberaubend! Cristhofer sprach ausgezeichnet Englisch und wusste alles über die Geschichte des Viertels. Das Preis-Leistungs-Verhältnis war hervorragend. Ich empfehle ihn jedem, der Lima besucht!", avatar: "LH", color: "bg-red-500" },
  { name: "Familia Rodrigues", country: "Brazil",       flag: "🇧🇷", rating: 5, tour: "Family Tour",              text: "Fomos com nossos três filhos e Cristhofer foi incrível com as crianças! A Huaca Pucllana deixou nossos filhos impressionados. Com certeza voltaremos e contrataremos ele novamente!", avatar: "FR", color: "bg-green-600" },
  { name: "Isabelle Moreau",  country: "France",        flag: "🇫🇷", rating: 5, tour: "Food Tour",               text: "En tant que française passionnée de gastronomie, je pensais que rien ne pourrait me surprendre... Cristhofer m'a emmenée dans des endroits incroyables où j'ai découvert le vrai ceviche, le tiradito, la causa. C'était une révélation culinaire!", avatar: "IM", color: "bg-indigo-500" },
  { name: "Marco & Elena",    country: "Argentina",     flag: "🇦🇷", rating: 5, tour: "Historical Tour",         text: "Llegamos a Lima sin saber qué hacer y Cristhofer nos cambió el viaje. Su conocimiento histórico es impresionante. El vehículo era cómodo y llegó puntual. Los recomendamos sin dudarlo.", avatar: "ME", color: "bg-cyan-600" },
];
